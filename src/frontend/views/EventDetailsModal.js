      ...
      >
        <Fade in={open}>
          <div className={classes.paper}>
            <BoundingBoxDisplay imageSource={openModalEvent.imageSource} boundingBox={selectedPrediction.boundingBox}/>
            <PredictionInfoDisplay predictions={openModalEvent.predictions} activeScore={activeScore}/>
            <PredictionSelector activeScore={activeScore} setActiveScore={setActiveScore} numScores={openModalEvent?.predictions?.length}/>
          </div>
        </Fade>
      </Modal>
    </div>
